...
<v-container fluid class="message ">
                ...
                <v-form>
                    <v-row>
                        <v-col cols="12" sm="12" md="12" lg="12">
                            <v-text-field type="text" label="Name" color="blue " disabled class="rounded-lg" outlined dense required v-model="assetEdit.furniture_type"></v-text-field>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="12" sm="12" md="12" lg="12">
    ...
    <v-data-table :headers="headers" :items="assets" :page.sync="page" :items-per-page="itemsPerPage" hide-default-footer :search="search" class="elevation-0 " @page-count="pageCount = $event">
    ...
    <v-row class="pagination-row mx-8">
        <v-col cols sm="6" md="6" lg="6">
            <p class="items-range blue--text text-darken-4">
                <b>Showing {{ startIndex }} - {{ endIndex }} out of {{ assets.length }}</b>
            </p>
        </v-col>
...
export default {
    ...
    methods: {
        ...
        async assignAsset() {
            ...
            this.isLoading = true
            await axios.post(
                    "/assign-furniture/" + this.assetEdit.id, {
