            ...
            <div class="text-center">
                <v-menu offset-y>
                    ...
                    <v-list>
                        ...
                        <!-- <v-list-item class="custom-list-item" v-if="item.payment_status != 'PAID' || item.sale_status==='PENDING'">
                            <v-list-item-title>
                                <v-btn small class="btn" text color="blue lighten-1" @click="saleEdit(item)">
                                    <v-icon>mdi-pencil</v-icon> Complete Sale
                                </v-btn>
                            </v-list-item-title>
                        </v-list-item> -->
                        <!-- 
                        <template v-if="item.payment_status === 'PAID' ">
                            <v-list-item class="custom-list-item">
            
                                <v-list-item-title>
                                    <v-btn small text class="btn" color="blue lighten-1" @click="printReceipt(item)">
                                        <v-icon>mdi-file</v-icon> Receipt
                                    </v-btn>
                                </v-list-item-title>
                        ...
                        <template v-else>
                            <v-list-item class="custom-list-item">
                                <v-list-item-title>
                                    <v-btn small text @click="printInvoice(item)" color="blue lighten-1" class="btn">
                                        <v-icon>mdi-file</v-icon> Generate Invoice
                                    </v-btn>
                                </v-list-item-title>
                            </v-list-item>
                        </template> -->
...
export default {
    ...
    computed: {
        ...
        filteredAssets() {
            return this.assets.filter(asset => asset.asset.subcategory === 'Printer');
        },
