                ...
                <v-form>
                    <v-row class="mt-5">
                        <v-col cols="12" sm="6" md="6">
                            <v-text-field type="text" outlined dense class="rounded-lg " label="Name" v-model="assetEdit.computer_type" disabled></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <v-select label="--Select Condition--" class="rounded-lg" outlined dense v-model="unassign.condition" :items="statusOptions ">
                            </v-select>
                        </v-col>
                    </v-row>
                ...
                <v-form>
                    <v-row>
                        <v-col cols="12" sm="12" md="12" lg="12">
                            <v-text-field type="text" label="Name" color="blue " disabled class="rounded-lg" outlined dense required v-model="assetEdit.modeli"></v-text-field>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="12" sm="12" md="12" lg="12">
...
export default {
    ...
    computed: {
        ...
        filteredAssets() {
            return this.assets.filter(asset => asset.asset.subcategory === 'Television');
        },
        customDateFormat() {
            return value => {
                if (!value) return '';
